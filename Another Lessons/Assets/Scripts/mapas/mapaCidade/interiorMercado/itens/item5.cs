...
public class item5 : MonoBehaviour {
    ...
    public GameObject ciencias, btnComprar, lblJaPossui, bkgConversa, btnSair, lblMochilaCheia;
    ...
    public void abrirCiencias()
    {
        ...
        else
        {
            for (int n = 0; n != 6; n++)
            {
                if (Char.Itens[n] == ("livroCiencias" + Char.Nivel))
                {
                    temOItem++;
                }
            }
    ...
    public void comprarClick()
    {
        ...
        if (Char.Moedas >= verificaNivel)
        {
            ...
            for (int n = 0; n != 6; n++)
            {
                if (Char.Itens[n] == "null")
                {
                    Char.Itens[n] = "livroCiencias" + Char.Nivel;
                    n = 5;
                }
            }
        }
