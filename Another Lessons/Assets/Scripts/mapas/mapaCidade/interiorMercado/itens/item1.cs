...
public class item1 : MonoBehaviour {
    ...
    public GameObject matematica, btnComprar, lblJaPossui, bkgConversa, btnSair, lblMochilaCheia;
    ...
    {        
        matematica.SetActive(false);
    }

    public void abrirMatematica()
    {
        matematica.SetActive(true);
        ...
        else
        {
            ...
            for (int n = 0; n != 6; n++)
            {
                if (Char.Itens[n] == ("livroMatematica" + Char.Nivel))
                {
                    temOItem++;
                }
            }
