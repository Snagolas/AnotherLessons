...
public class item2 : MonoBehaviour {
    ...
    public GameObject portugues, btnComprar, lblJaPossui, bkgConversa, btnSair, lblMochilaCheia;
    ...
    public void abrirPortugues()
    {
        ...
        else
        {
            for (int n = 0; n != 6; n++)
            {
                if (Char.Itens[n] == ("livroPortugues" + Char.Nivel))
                {
                    temOItem++;
                }
            }
    ...
    public void comprarClick()
    {
        ...
        if (Char.Moedas >= verificaNivel)
        {
            ...
            for (int n = 0; n != 6; n++)
            {
                if (Char.Itens[n] == "null")
                {
                    Char.Itens[n] = "livroPortugues" + Char.Nivel;
                    n = 5;
                }
            }
        }
