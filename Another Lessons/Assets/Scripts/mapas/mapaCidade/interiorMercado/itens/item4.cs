...
public class item4 : MonoBehaviour {
    ...
    public GameObject geografia, btnComprar, lblJaPossui, bkgConversa, btnSair, lblMochilaCheia;
    ...
    {
        geografia.SetActive(false);
    }

    public void abrirGeografia()
    {
        ...
        else
        {
            for (int n = 0; n != 6; n++)
            {
                if (Char.Itens[n] == ("livroGeografia" + Char.Nivel))
                {
                    temOItem++;
                }
            }
    ...
    public void comprarClick()
    {
        ...
        if (Char.Moedas >= verificaNivel)
        {
            ...
            for (int n = 0; n != 6; n++)
            {
                if (Char.Itens[n] == "null")
                {
                    Char.Itens[n] = "livroGeografia" + Char.Nivel;
                    n = 5;
                }
            }
        }
