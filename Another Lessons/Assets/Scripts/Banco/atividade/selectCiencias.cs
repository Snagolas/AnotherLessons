...
public class selectCiencias : MonoBehaviour
{
    ...
    IEnumerator ciencias()
    {
        ...
        {
            case 1:
                infoData = new WWW("http://localhost/projetos/selectCiencias2.php");

                print("executou nivel 1");
                break;
            case 2:
                infoData = new WWW("http://localhost/projetos/selectCiencias3.php");

                print("executou nivel 2");
                break;
            case 3:
                infoData = new WWW("http://localhost/projetos/selectCiencias4.php");

                print("executou nivel 3");
                break;
            case 4:
                infoData = new WWW("http://localhost/projetos/selectCiencias5.php");
    ...
    public void chamaCiencias()
    {
        HUD.SetActive(false);
        StartCoroutine("ciencias");
    }
}
