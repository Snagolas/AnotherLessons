...
public class selectGeografia : MonoBehaviour
{
    ...
    IEnumerator geografia()
    {
        ...
        {
            case 1:
                infoData = new WWW("http://localhost/projetos/selectGeografia2.php");

                print("executou nivel 1");
                break;
            case 2:
                infoData = new WWW("http://localhost/projetos/selectGeografia3.php");

                print("executou nivel 2");
                break;
            case 3:
                infoData = new WWW("http://localhost/projetos/selectGeografia4.php");

                print("executou nivel 3");
                break;
            case 4:
                infoData = new WWW("http://localhost/projetos/selectGeografia5.php");
    ...
    public void chamaGeografia()
    {
        HUD.SetActive(false);
        StartCoroutine("geografia");
    }
}
