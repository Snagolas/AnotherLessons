...
public class selectMatematica : MonoBehaviour
{
    ...
    IEnumerator matematica()
    {
        ...
        {
            case 1:
                infoData = new WWW("http://localhost/projetos/selectMatematica2.php");

                print("executou nivel 1");
                break;
            case 2:
                infoData = new WWW("http://localhost/projetos/selectMatematica3.php");

                print("executou nivel 2");
                break;
            case 3:
                infoData = new WWW("http://localhost/projetos/selectMatematica4.php");

                print("executou nivel 3");
                break;
            case 4:
                infoData = new WWW("http://localhost/projetos/selectMatematica5.php");
