...
public class selectHistoria : MonoBehaviour
{
    ...
    IEnumerator historia()
    {
        ...
        {
            case 1:
                infoData = new WWW("http://localhost/projetos/selectHistoria2.php");

                print("executou nivel 1");
                break;
            case 2:
                infoData = new WWW("http://localhost/projetos/selectHistoria3.php");

                print("executou nivel 2");
                break;
            case 3:
                infoData = new WWW("http://localhost/projetos/selectHistoria4.php");

                print("executou nivel 3");
                break;
            case 4:
                infoData = new WWW("http://localhost/projetos/selectHistoria5.php");
